...
const stroke = (d, extra = '') =>
  `<svg viewBox="0 0 24 24" aria-hidden="true" ${extra}>${d}</svg>`;
...
export const icons = {
  ...
  play: '<svg viewBox="0 0 24 24" aria-hidden="true"><polygon points="6 3 21 12 6 21"/></svg>',
...
export const brandIcons = {
  youtube:
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M23 12s0-3.9-.5-5.7c-.3-1-1.1-1.9-2.1-2.1C18.6 3.7 12 3.7 12 3.7s-6.6 0-8.4.5c-1 .3-1.8 1.1-2.1 2.1C1 8.1 1 12 1 12s0 3.9.5 5.7c.3 1 1.1 1.9 2.1 2.1 1.8.5 8.4.5 8.4.5s6.6 0 8.4-.5c1-.3 1.8-1.1 2.1-2.1.5-1.8.5-5.7.5-5.7zM9.8 15.5v-7l6.3 3.5z"/></svg>',
  github:
  ...
  patreon:
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M15.4 2.1c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6 4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6zM1 22.1h3.7V2.1H1z"/></svg>',
  bmc:
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.2 6.6c-.2-.9-.9-1.4-1.8-1.6-1.5-.3-3-.4-4.5-.4-1.7 0-3.4.1-5.1.3-.6.1-1.2.1-1.8.2-.7.1-1.3.4-1.6 1-.3.6-.3 1.3-.1 1.9.2.6.7 1 1.3 1.1l.2.1 1.3 8.5c.1.7.3 1.4.8 1.9.6.6 1.4.8 2.2.9 1 .1 2 .1 3 .1s2 0 3-.2c.8-.1 1.5-.4 2-1s.7-1.3.8-2l1.2-8.3c.7-.2 1.2-.7 1.4-1.4.1-.4.1-.7 0-1.1zM9.9 16.9c-.5.2-1 .3-1.5.2l-.7-4.6c.9.3 1.9.5 2.9.5 1.3 0 2.6-.3 3.8-.7.4-.1.8-.3 1.2-.4l-.6 3.9c-1.6.6-3.3 1-5.1 1.1z"/></svg>',
